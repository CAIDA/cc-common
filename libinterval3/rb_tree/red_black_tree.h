/* 
 * Red-Black Tree algorithm implementation.
 *
 * Originally forked from 
 *     http://web.mit.edu/~emin/www.old/source_code/red_black_tree/index.html
 *
 * and modified by Vasco Asturiano (vasco@caida.org) to allow tree augmentation 
 * using callback triggers on tree rotations.
 *
 */
...
typedef struct rb_red_blk_tree {
  ...
  void (*RotationCallback)(rb_red_blk_node* rot_node);
